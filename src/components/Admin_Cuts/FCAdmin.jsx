              ...
              <div className=" px-4 flex flex-col justify-between">
                ...
                <div className="flex flex-col justify-start items-start">
                  <div className="flex justify-between w-full">
                    <b className="text-2xl italic">First cut</b>
                    <button
                      onClick={toggleModal}
                  ...
                  <div className="flex flex-col justify-start items-start max-w-[400px] w-full">
                   <p className="text-xl">Accept First cut ?</p>
                ...
                <div className="flex justify-end items-end gap-2">
                  <button className="bg-[#112D4E] hover:bg-[#215590] rounded-full text-white px-2" onClick={(e)=>handleFirstCut1(e)}>
                    Accept Cut 
                  </button>
                  <button className="bg-[#b81818] hover:bg-[#215590] rounded-full text-white px-2" onClick={(e)=>handleFirstCut2(e)}>
                    Reject Cut
                  </button>
                </div>
              </div>
