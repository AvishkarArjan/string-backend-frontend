            ...
            <div className=" relative p-5 grid grid-cols-1 lg:grid-cols-2 w-fit bg-[#fff] rounded-md h-fit mx-8">
              <div className="content w-fit">
                ...
                <div>
                  <img
                    ...
                    className="my-2 w-44 rounded-md shadow-md shadow-[#818181]"
                    alt=""
                  />
                </div>
              ...
              <div className=" px-4 flex flex-col justify-between">
                ...
                <div className="flex flex-col justify-start items-start">
                  ...
                  <b className="text-2xl italic">First cut Details</b>
                ...
                <div className="flex justify-end items-end">
                  <button className="bg-[#112D4E] hover:bg-[#215590] rounded-full text-white px-2 mt-4" onClick={(e)=>handleFirstCut(e)}>
                    Mark First Cut Complete
                  </button>
                </div>
              </div>
            </div>
