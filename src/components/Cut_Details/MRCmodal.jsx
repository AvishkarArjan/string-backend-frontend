...
const MRCmodal = (props) => {
  const [modal, setModal] = useState(false);
  const toggleModal = () => {
    setModal(!modal);
  };

  const handlemultiCamRoughCut = (event) => {
    event.preventDefault();
    axios
      .post(`${url}/employee`, {
        title: props.data.title,
        multiCamRoughCut: true,
              ...
              <div className=" px-4 flex flex-col justify-between">
                <div className="flex flex-col justify-start items-start">
                  <div className="flex justify-between w-full">
                    <b className="text-xl">multiCam Rough cut Details</b>
                    <button
                      onClick={toggleModal}
                  ...
                  <div className="flex flex-col justify-start items-start max-w-[400px] w-full">
                    ...
                    <p className="flex">
                      ...
                      <p className="w-fit flex justify-start items-start">
                      Import the sequence into premier pro
                      </p>
                    </p>
                    <p className="flex">
                      <b className="w-14 flex justify-start items-start">
                      ...
                      <p className="w-80 flex justify-start items-start">
                        Copy the synched sequence to "Multicam Rough Cut" & place it at
                        "Start Edit" marker
                      </p>
                    </p>
                  </div>
                ...
                <div className="flex justify-end items-end">
                  <button
                    ...
                    onClick={(e) => handlemultiCamRoughCut(e)}
                  >
                    Mark multicam Rough Cut Complete
                  </button>
                </div>
              </div>
            </div>
