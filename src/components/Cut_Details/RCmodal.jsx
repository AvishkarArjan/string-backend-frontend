              ...
              <div className="content w-fit">
                ...
                <div>
                  <img
                    ...
                    className="my-2 w-44 rounded-md shadow-md shadow-[#525252]"
                    alt=""
                  />
                </div>
              ...
              <div className=" px-4 flex flex-col justify-between">
                <div className="flex flex-col justify-start items-start">
                  <div className="flex justify-between w-full">
                    <b className="text-2xl italic">Rough cut Details</b>
                    <button
                      onClick={toggleModal}
                  ...
                  <div className="flex flex-col justify-start items-start max-w-[400px] w-full">
                    ...
                    <p className="flex">
                      ...
                      <p className="w-80 flex justify-start items-start">
                        Copy the synched sequence to "Rough Cut" & place it at
                        "Start Edit" marker
                      </p>
                    </p>
                  </div>
                ...
                <div className="flex justify-end items-end">
                  <button
                    ...
                    onClick={(e) => handleRoughCut(e)}
                  >
                    Mark Rough Cut Complete
                  </button>
                </div>
              </div>
            </div>
