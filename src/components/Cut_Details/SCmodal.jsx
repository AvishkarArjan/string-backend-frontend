              ...
              <div className=" px-4 flex flex-col justify-between">
                ...
                <div className="flex flex-col justify-start items-start">
                  <div className="flex justify-between w-full">
                    <b className="text-2xl italic">Second cut Details</b>
                    <button
                      onClick={toggleModal}
                ...
                <div className="flex justify-end items-end">
                  <button className="bg-[#112D4E] hover:bg-[#215590] rounded-full text-white px-2 mt-4" onClick={(e)=>handleSecondCut(e)}>
                    Mark Second Cut Complete
                  </button>
                </div>
              </div>
            </div>
